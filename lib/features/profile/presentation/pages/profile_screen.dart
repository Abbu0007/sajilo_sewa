...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadUser() async {
    ...
    final res = await HiveService.instance.getSessionUser();
    res.fold(
      (f) => setState(() {
  ...
  Widget build(BuildContext context) {
    final name = _loadingUser ? "Loading..." : (_user?.fullName ?? "User");
    final email = _loadingUser ? "" : (_user?.email ?? "");
    final phone = _loadingUser ? "" : (_user?.phone ?? "Phone: N/A");
