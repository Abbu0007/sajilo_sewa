...
class UrlUtils {
  ...
  static String normalizeMediaUrl(String? url) {
    ...
    if (url.contains('http://10.0.2.2:')) {
      return url.replaceFirst('http://10.0.2.2:5000', ApiEndpoints.serverUrl);
    }

    if (url.contains('https://10.0.2.2:')) {
      return url.replaceFirst('https://10.0.2.2:5000', ApiEndpoints.serverUrl);
    }
